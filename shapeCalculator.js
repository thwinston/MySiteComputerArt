...
else if (shape==="cornhub"){
    confirm("CORNCORNCORNCORNCORNCORNCORNCORNPORNCORNCORNCORNCORN");
    return("EasterEgg: cornHub");
}
    
else {
    confirm("What the heck kinda shape is that?");
    return("Error: User entered an invalid shape");
}
